            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="company" class="form-control mycustom" placeholder="Company name"
                            value="{{ old('company', $info->company ?? '') }}" />
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="tel" name="phone" class="form-control mycustom" placeholder="Phone number"
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="website" class="form-control mycustom" placeholder="Company website"
                        ...
                        <select name="language" aria-label="{{ __('Select a Language') }}" data-control="select2"
                            ...
                            @foreach (\App\Core\Data::getLanguagesList() as $key => $value)
                                <option data-kt-flag="{{ $value['country']['flag'] }}" value="{{ $key }}"
                                    {{ $key === old('language', $info->language ?? '') ? 'selected' : '' }}>
                                    {{ $value['name'] }}</option>
                            @endforeach
                        </select>
                        <!--end::Input-->
                    ...
                    <div class="col-lg-8 fv-row">
                        <select name="currency" aria-label="{{ __('Select a Currency') }}" data-control="select2"
                            ...
                            @foreach (\App\Core\Data::getCurrencyList() as $key => $value)
                                <option data-kt-flag="{{ $value['country']['flag'] }}" value="{{ $key }}"
                                    {{ $key === old('currency', $info->currency ?? '') ? 'selected' : '' }}>
                                    <b>{{ $key }}</b>&nbsp;-&nbsp;{{ $value['name'] }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-8 fv-row">
                        ...
                        <div class="d-flex align-items-center mt-3">
                            ...
                            <label class="form-check form-check-inline form-check-solid me-5">
                                ...
                                <input class="form-check-input" name="communication[email]" type="checkbox"
                                    value="1"
                            ...
                            <label class="form-check form-check-inline form-check-solid">
                                ...
                                <input class="form-check-input" name="communication[phone]" type="checkbox"
                                    value="1"
