                                                    ...
                                                    <div class="row m-l-0 m-r-0">
                                                        <div class="col-sm-4 bg-c-lite-green user-profile">
                                                            <div class="card-block text-center text-white">
                                                                <div class="m-b-25">
                                                                    <img width="75" style="height: 75px;" src="{{display_image($item->photo)}}" class="img-radius" alt="User-Profile-Image">
                                                                </div>
                                                                <h4 class="f-w-600">{{$item->first_name}}</h4>
                                                                {{-- <p>Web Designer</p>
                                                                <p>Web Designer</p> --}}
                                                                @foreach ($item->specialties as $specialty)
                                                                <span class="fs-9">{{$specialty->name}}</span><br>
                                                            @endforeach
                                                            ...
                                                            <div class="card-block">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <h6 class="text-muted f-w-400"><a class="text-muted f-w-400" href="tel:+{{$item->phone}}">{{$item->phone}}</a></h6>
                                                                    </div>
                                                                </div>
