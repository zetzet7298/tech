                        ...
                        @foreach ($solutions as $row)
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <a href="{{ route('solutions.edit', ['solution' => $row->id]) }}" href="javascript:void(0);" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                    <a
                                    href="{{ route('solutions.destroy', ['solution' => $row->id]) }}"
