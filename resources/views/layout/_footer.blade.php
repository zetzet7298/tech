    ...
    <div class="center-layout pd0__mobile_layout">
        <div class="footer__grid">
            <div class="footer__col">
                ...
                <div class="footer__title mt-3">Trụ sở chính
                ...
                <div class="footer-mobile-hidden" id="footer-mobile-hidden-1">
                    <div class="footer-mobile-hidden--content">
                        ...
                        <div><b>Thời gian hoạt động:</b> {{ $TIME_WORKING }}</div>
                    </div>
                </div>
                <div class="footer__title mt-3">{{ $VANPHONG }}
                ...
                <div class="footer-mobile-hidden" id="footer-mobile-hidden-2">
                    <div class="footer-mobile-hidden--content">
                        <div><b>Địa chỉ: </b><a style="font-weight: 100;" class="text-black" target="_blank"
                                rel="nofollow noopener" href="{{ $GOOGLE_MAP }}">{{ $DIACHIVANPHONG }}</a></div>
                        <div><b>Email: </b>
                            <span style="font-weight: 100;">{{ $EMAILVANPHONG }}</span>
                        </div>
                        <div>
                ...
                <div class="footer-mobile-hidden">
                    <div class="footer__title mt-3">Kết nối với chúng tôi</div>
