    ...
    @else
        ...
        <div class="d-flex flex-column flex-root">
            ...
            @if( theme()->getOption('layout', 'aside/display') === true )
                {{ theme()->getView('layout/demo1/aside/_base') }}
            @endif

                <!--begin::Wrapper-->
                <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                {{ theme()->getView('layout/demo1/header/_base') }}
                    ...
                    @if (theme()->getOption('layout', 'toolbar/display') === true)
                        {{ theme()->getView('layout/demo1/toolbars/_' . theme()->getOption('layout', 'toolbar/layout')) }}
                    @endif

                        <!--begin::Post-->
                        <div class="post d-flex flex-column-fluid" id="kt_post">
                            {{ theme()->getView('layout/demo1/_content', compact('slot')) }}
                        </div>
                        <!--end::Post-->
                    </div>
                    <!--end::Content-->

                    {{ theme()->getView('layout/demo1/_footer') }}
                </div>
                <!--end::Wrapper-->
            </div>
            <!--end::Page-->
        ...
        @if(theme()->getOption('layout', 'scrolltop/display') === true)
            {{ theme()->getView('layout/demo1/_scrolltop') }}
        @endif
    @endif
    <!--end::Main-->
