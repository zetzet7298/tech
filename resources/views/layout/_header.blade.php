    ...
    <div class="header ">
        <div class="center-layout">
            <a href="https://mikotech.vn" class="himg" rel="doffolow">
                {{-- <svg width="180" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <defs>
                        ...
                        <linearGradient id="linear-gradient-1" x1="858.66" y1="550.21" x2="858.66"
                            y2="550.21" gradientUnits="userSpaceOnUse">
                            <stop offset="0" stop-color="#70efd1" />
                            <stop offset="1" stop-color="#1bc1c1" />
                        </linearGradient>
                        <linearGradient id="linear-gradient-1-2" x1="1451.9" y1="560.07" x2="553.12"
                            y2="542.5" xlink:href="#linear-gradient-1" />
                        <linearGradient id="linear-gradient-1-3" x1="905.82" y1="66.05" x2="7.04"
                            y2="48.48" xlink:href="#linear-gradient-1" />
                        <linearGradient id="linear-gradient-1-4" x1="1451.96" y1="557.17" x2="553.18"
                            y2="539.6" xlink:href="#linear-gradient-1" />
                        <linearGradient id="linear-gradient-1-5" x1="1451.99" y1="555.49" x2="553.21"
                            y2="537.92" xlink:href="#linear-gradient-1" />
                        <linearGradient id="linear-gradient-1-6" x1="1452.03" y1="553.46" x2="553.25"
                            y2="535.9" xlink:href="#linear-gradient-1" />
                        <linearGradient id="linear-gradient-1-7" x1="1452.13" y1="548.69" x2="553.35"
                            y2="531.12" xlink:href="#linear-gradient-1" />
                        <linearGradient id="linear-gradient-1-8" x1="1452.16" y1="547.11" x2="553.38"
                            y2="529.54" xlink:href="#linear-gradient-1" />
                        <linearGradient id="linear-gradient-1-9" x1="1452.19" y1="545.2" x2="553.41"
                            y2="527.63" xlink:href="#linear-gradient-1" />
                        <linearGradient id="linear-gradient-1-10" x1="1452.24" y1="543.04" x2="553.46"
                            y2="525.48" xlink:href="#linear-gradient-1" />
                    </defs>
            ...
            <a href="https://mikotech.net/"
              class="miko__language-option miko__language-option--en notranslate w-[25px] h-[20px] p-0 bg-transparent rounded-none cursor-pointer text-[10px] font-bold text-white no-underline	 leading-5 text-center absolute left-[30px] top-[5px] z-40">EN</a>
          </div> --}}
            </div>
        </div>
    </div>
    ...
    <div class="hmmenu">
        <div class="hmmenu__header">
            {{-- <a href="https://mikotech.vn" class="himg hmmenu__logo">
                <img alt="Dịch vụ Digital Marketing Tổng Thể Doanh Nghiệp | Levo Security"
                    src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20180%2033'%3E%3C/svg%3E"
                    data-lazy-srcset="https://mikotech.vn/wp-content/themes/mikotech/assets/images/logo.webp 576w, https://mikotech.vn/wp-content/themes/mikotech/assets/images/logo.webp 992w, https://mikotech.vn/wp-content/themes/mikotech/assets/images/logo.webp 1440w"
                    width="180" height="33" alt="Logo"
                    data-lazy-src="https://mikotech.vn/wp-content/themes/mikotech/assets/images/logo.webp"><noscript><img
                        alt="Dịch vụ Digital Marketing Tổng Thể Doanh Nghiệp | Levo Security"
                        src="https://mikotech.vn/wp-content/themes/mikotech/assets/images/logo.webp"
                        ...
                        width="180" height="33" alt="Logo"></noscript>
            </a> --}}
        </div>
