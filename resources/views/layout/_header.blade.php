...
<div id="hcontainer">
                ...
                <div class="header__nav_container">
                    <ul id="menu-menu-chinh" class="header__nav">
                        ...
                        <li id="menu-item-391"
                            ...
                            <a href="{{ route('gioithieu') }}">Giới thiệu</a></li>
                        <li id="menu-item-386"
    ...
    <div class="hmmenu">
        ...
        <div class="hmmenu__main">
            <div class="hmmenu__nav_container">
                <ul id="menu-menu-chinh-1" class="hmmenu__nav">
                    ...
                    <li
                        class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-392">
        ...
        <div class="svg-menu">
            <svg id="scene" preserveAspectRatio="xMinYMid slice" viewBox="0 0 1440 800" class="style-1" style="opacity: 0;">
              <defs>
