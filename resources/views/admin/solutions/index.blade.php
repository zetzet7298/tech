...
<div class="card card-xxl-stretch mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
            ...
            <a href="{{ route('solutions.create') }}" class="btn btn-sm btn-light-primary">
                    ...
                    @foreach ($solutions as $row)
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <a href="{{route('solutions.destroy', ['solution' => $row->id])}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm"
