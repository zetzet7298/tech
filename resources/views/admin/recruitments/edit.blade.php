        ...
        <div class="card">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bolder m-0">{{ __('Tạo tin tuyển dụng') }}</h3>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="kt_account_profile_details" class="collapse show">
                ...
                <form id="kt_account_profile_details_form" class="form" method="POST"
                    action="{{ route('recruitments.update', ['recruitment' => $recruitment->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!--begin::Card body-->
                ...
                <!--end::Input group--> --}}
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-10">
                                <!--begin::Image input-->
                                <div class="image-input image-input-outline {{ $recruitment->image ? '' : 'image-input-empty' }}"
                                    data-kt-image-input="true"
                                    style="background-image: url({{ display_image($recruitment->image) }})">
                                    <!--begin::Preview existing avatar-->
                                    <div class="image-input-wrapper w-250px h-250px"
                                    style="background-image: url({{ display_image($recruitment->image) }})"></div>
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-10 fv-row">
                                <textarea required rows="10" type="text" name="desc"
                                    class="form-control form-control-lg form-control-solid" placeholder="" value="">{{$recruitment->desc}}</textarea>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-10 fv-row">
                                <input required type="number" name="index"
                                    class="form-control form-control-lg form-control-solid" placeholder="" value="{{$recruitment->index}}"/>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
