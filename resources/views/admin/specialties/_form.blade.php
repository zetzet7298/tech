        ...
        <div class="card">
            ...
            <div id="kt_account_profile_details" class="collapse show">
                ...
                <form id="kt_account_profile_details_form" class="form" method="POST"
                    @if (isset($item)) action="{{ route('specialties.update', ['specialty' => $item->id]) }}"
                    @else
                    action="{{ route('specialties.store') }}" @endif
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-2 col-form-label fw-bold fs-6">{{ __('Tên chuyên ngành') }}</label>
                            <!--end::Label-->
